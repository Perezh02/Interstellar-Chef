...
public class SMSam extends Entity {
    ...
    public void getImage() {
        up1 = setup("/npc/spaceman_orange_up_1");
        up2 = setup("/npc/spaceman_orange_up_2");
        down1 = setup("/npc/spaceman_orange_down_1");
        down2 = setup("/npc/spaceman_orange_down_2");
        left1 = setup("/npc/spaceman_orange_left_1");
        left2 = setup("/npc/spaceman_orange_left_2");
        right1 = setup("/npc/spaceman_orange_right_1");
        right2 = setup("/npc/spaceman_orange_right_2");
    }
